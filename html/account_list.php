    ...
    <main class="main-content">
        <div class="content-wrapper">
            ...
            <form action="account_list.php" method="get" class="account-search-form">
              ...
              <div class="form-group checkbox-group">
                <label for="no_task_user">
                  ...
                  <?php if(isset($_GET['no_task_user']) && $_GET['no_task_user'] == 1):?>checked<?php endif ?>>タスクを持っていないユーザー
                </label>
              </div>
            ...
            <div class="account-row">
                <div class="account-cell cell-id"><?php echo h($user['id']) ;?></div>
                <div class="account-cell cell-username"><?php echo h($user['nickname']) ?></div>
                <div class="account-cell cell-registration">
                  <?php 
                    $user['created_at'] = dateCalligraphy($user['created_at']); echo $user['created_at'] 
                  ?>
                </div>
                <div class="account-cell cell-update">
                  <?php 
                    $user['updated_at'] = dateCalligraphy($user['updated_at']); echo $user['updated_at'] ;
                  ?>
                </div>
